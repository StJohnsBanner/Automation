...
public class TestUtility {
		...
		public static void Login(WebDriver driver, String username, String password) 
		{
			...
			if(TestUtility.CheckForFieldInIframeByName(driver, "Welcome")==true) 
			{ 	
			...
			else
			{
				...
				System.out.println("User failed to log in, this test can not be run");
		...
		public static void SearchForForm(WebDriver driver, String formName) 
		{
			try 
			{
				...
				if( driver.findElement(By.id("search-landing")).getText() != null)
				{			
			...
			{
				System.out.println("User is not on the search for form page");
		 ...
		 * @param fieldName Name of field as shown on screen
		 */
		public static String XpathText(String fieldName) 
		{
				String a= "( //*[contains(text(),'"+ fieldName+"')])";
				return a;
